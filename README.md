...
> this project is not about creating a new health-care system. It is creating a __data-centric, node.js based framework__ for efficiently using the powerful, multi-faceted, widely-deployed VISTA system. Without VISTA, the framework would be useless. With the framework VISTA will be a lot more useful.
