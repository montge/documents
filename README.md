...
E1 | B | RPC Model | Q1 &#8594; Q2 | [VDM](https://github.com/vistadataproject/VDM), [nodeVISTA](https://github.com/vistadataproject/nodeVISTA) | formal definition of the model implicit in "write-back RPCs" (rpc.jsonld) for write support in vdm.jsonld (#7) | JSON-LD, Python | &nbsp;
