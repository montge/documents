...
11 | C |  [MVDM over VDM] Heuristic (mapping) code [_MVDM Module_] | Q2 &#8594; Q4 | [MVDM](https://github.com/vistadataproject/MVDM) | mapping tables and rules implemented in a _MVDM module_ to enable expanding MVDM to VDM mapping.<br><br>Builds on the _VDM Package_ (#E1).<br>The first version will support query/read ("MVDM Module (read)"); full CRUD support will follow. | Javascript (node.js), JSON | 5.3.2
