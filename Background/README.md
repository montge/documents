...
:--- | :--- | :---
[Rafael_Richards](https://www.linkedin.com/in/rafaelrichardsmd) |![](/images/logos-presentations/60h/linkedVISTA.jpg) | [__Linked VISTA__](https://github.com/vistadataproject/documents/blob/master/Background/presentations/Linked_VISTA-2015.pdf) This describes the design of a cross-linked Master VISTA Data Model ([MVDM](https://github.com/vistadataproject/MVDM)) to provide enterprise read and write master data management across all VA VISTA systems. (2015) [PDF](https://github.com/vistadataproject/documents/blob/master/Background/presentations/Linked_VISTA-2015.pdf)
