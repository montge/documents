...
:--- | --- | :---: | ---
[George Timson] and <br>Tom Munnecke | [VA FileMan](https://en.wikipedia.org/wiki/FileMan) | VDM | The pair who concieved and built VISTA on a metadata-driven architecture
...
Kevin Meldrum | [VA's Virtual Patient Record (VPR)](http://www.va.gov/vdl/application.asp?appid=197) | MVDM |  Created a JSON-based mechanism for accessing VISTA's patient data 
